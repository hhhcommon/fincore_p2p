...
import com.zb.p2p.trade.common.util.ExecutorsFactory;
...
public class MnsMsgHandlerThread extends Thread {
     ...
     * 消息监听处理器
     */
    private AbstractMnsMsgHandler mnsTopicListener;
    ...
    public MnsMsgHandlerThread(boolean weakConsumer, CloudAccount cloudAccount, int waitSeconds,
                               String queueName, AbstractMnsMsgHandler mnsTopicListener) {
    ...
    public AbstractMnsMsgHandler getMnsTopicListener() {
        return mnsTopicListener;
    }

    public void setMnsTopicListener(AbstractMnsMsgHandler mnsTopicListener) {
        this.mnsTopicListener = mnsTopicListener;
    }
