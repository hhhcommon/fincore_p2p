...
/**
 * 计算产品计划库存. <br/>
 * Date: 2018年4月20日 下午6:31:28 <br/>
 *
 * @author kaiyun@zillionfortune.com
 * @version 
 * @since JDK 1.7
 */
@Component("countProductPlanStockTask")
public class CountProductPlanStockTask implements IScheduleTaskDealSingle<ProductCreatePlan> {
	private static Logger logger = LoggerFactory.getLogger(CountProductPlanStockTask.class);
	...
	public List<ProductCreatePlan> selectTasks(String taskParameter,String ownSign,int taskQueueNum,
		...
		logger.info("计算产品计划库存job开始了……");
		productPlanJobServiceFacade.countProductPlanStock();
		return null;
	}
