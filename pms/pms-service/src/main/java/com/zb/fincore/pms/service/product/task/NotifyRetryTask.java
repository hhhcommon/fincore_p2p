...
public class NotifyRetryTask implements IScheduleTaskDealSingle<ProductCreatePlan> {
	private static Logger logger = LoggerFactory.getLogger(NotifyRetryTask.class);
