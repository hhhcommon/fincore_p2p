 ...
 * @since JDK 1.7
 */
@Component("productRaisingEndTask")
public class ProductRaisingEndTask implements IScheduleTaskDealSingle<Product> {
	private static Logger logger = LoggerFactory.getLogger(ProductRaisingEndTask.class);
