...
public class Constants {
    ...
    /** sequence name 产品名称前缀  */
    public static final String SEQUENCE_NAME_PREFIX_PRODUCT_NAME = "PN";
    /** sequence name 接口重试前缀 */
    public static final String SEQUENCE_NAME_PREFIX_RETRY = "RETRY";
    ...
    public static final String PRODUCT_VALUE_DATE_AFTER_EXPECT_CLEAR_DATE_CODE = "9066";
    public static final String PRODUCT_VALUE_DATE_AFTER_EXPECT_CLEAR_DATE_CODE_DESC = "产品起息日必须小于预期回款日";
    
    public static final String PRODUCT_NUMBERPERIOD_EXIST_RESULT_CODE = "9067";
    public static final String PRODUCT_NUMBERPERIOD_EXIST_RESULT_CODE_DESC = "产品期数相同的产品信息已存在";
    
    public static final String PRODUCT_PAY_CHANNEL_NOT_IN_ENUMS_RETURN_CODE = "9068";
    public static final String PRODUCT_PAY_CHANNEL_NOT_IN_ENUMS_RETURN_CODE_DESC = "支付渠道不在约定的范围";
    ...
    public static final String SALE_FLAG_NOT_IN_ENUMS_CODE = "9067";
    public static final String SALE_FLAG_NOT_IN_ENUMS_CODE_DESC = "在售/售罄区分参数值不在约定的范围";

    public static final String LOAN_ORDER_NO_SET_FORMAT_ERROR_CODE = "9068";
    public static final String LOAN_ORDER_NO_SET_FORMAT_ERROR_CODE_DESC = "借款订单编号集格式不正确";

    public static final String ON_SALE_PRODUCT_LIST_PREFIX = "ON_SALE_PRODUCT_LIST:";
    public static final String SOLD_OUT_PRODUCT_LIST_PREFIX = "SOLD_OUT_PRODUCT_LIST";
    public static final String ASC = "ASC";
    public static final String DESC = "DESC";
    public static final String ORDER_BY_DEFAULT = "ORDER_BY_DEFAULT";
    public static final String ORDER_BY_YIELD_RATE_ASC = "ORDER_BY_YIELD_RATE_ASC";
    public static final String ORDER_BY_YIELD_RATE_DESC = "ORDER_BY_YIELD_RATE_DESC";
    public static final String ORDER_BY_INVEST_PERIOD_ASC = "ORDER_BY_INVEST_PERIOD_ASC";
    public static final String ORDER_BY_INVEST_PERIOD_DESC = "ORDER_BY_INVEST_PERIOD_DESC";
    public static final String ORDER_BY_MIN_INVEST_AMOUNT_ASC = "ORDER_BY_MIN_INVEST_AMOUNT_ASC";
    public static final String ORDER_BY_MIN_INVEST_AMOUNT_DESC = "ORDER_BY_MIN_INVEST_AMOUNT_DESC";
}
