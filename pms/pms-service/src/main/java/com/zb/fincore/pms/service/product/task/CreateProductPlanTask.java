 ...
 * @since JDK 1.7
 */
@Component("createProductPlanTask")
public class CreateProductPlanTask implements IScheduleTaskDealSingle<ProductCreatePlan> {
	private static Logger logger = LoggerFactory.getLogger(CreateProductPlanTask.class);
	...
	public List<ProductCreatePlan> selectTasks(String taskParameter,String ownSign,int taskQueueNum,
		...
		logger.info("创建产品计划job开始了……");
		productPlanJobServiceFacade.createProductPlan();
		return null;
	}
