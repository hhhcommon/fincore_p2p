...
public enum InterfaceRetryBusinessTypeEnum {
    ...
    ASSET_MATCH_NOTIFY_MSD("ASSET_MATCH_NOTIFY_MSD", "资产匹配通知马上贷"),
    ASSET_MATCH_NOTIFY_AMS("ASSET_MATCH_NOTIFY_AMS", "资产匹配通知资管"),
    ASSET_MATCH_NOTIFY_AMS_REINVEST("ASSET_MATCH_NOTIFY_AMS", "资产匹配通知资管"),
    ...
    LOAN_PAYMENT_PROCESS_NOTIFY_MSD("LOAN_PAYMENT_PROCESS_NOTIFY_MSD", "通知马上贷放款中"),
    LOAN_NOTIFY_PAYMENT("LOAN_NOTIFY_PAYMENT", "通知支付放款"),
    LOAN_SUCCESS_NOTIFY_MSD("LOAN_SUCCESS_NOTIFY_MSD", "通知马上贷放款完成"),
