...
public class MnsMsgConsumer{
     ...
     * 消息处理器映射关系
     */
    private Map<String, MnsMsgHandler> topicListenerMap;
    ...
    public Map<String, MnsMsgHandler> getTopicListenerMap() {
        return topicListenerMap;
    }

    public void setTopicListenerMap(Map<String, MnsMsgHandler> topicListenerMap) {
