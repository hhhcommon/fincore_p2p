 ...
 */
@Component
public class P2PProductBizImpl implements P2PProductBiz {
    ...
    @Value("${p2p_product_register_url}")
    private String productRegisterUrl;
    
    @Value("${p2p_product_list_query_url}")
    private String productListQueryUrl;
    
    @Value("${p2p_product_info_query_url}")
    private String productInfoQueryUrl;

    @Value("${p2p_product_on_line_url}")
    private String productOnLineUrl;

    @Value("${p2p_product_off_line_url}")
    private String productOffLineUrl;
    
    @Value("${p2p_product_approval_url}")
    private String productApprovalUrl;

    @Value("${p2p_product_approval_info_list_url}")
    private String productApprovalInfoListUrl;

    @Value("${p2p_product_statistics_url}")
    ...
    public BaseWebResponse registerProduct(RegisterProductRequest req, String createBy, Integer userId) {
        log.info("P2PProductBizImpl.registerProduct.req:" + JSON.toJSONString(req));
        ...
        log.info("P2PProductBizImpl.registerProduct.resp:" + JSON.toJSONString(resp));
        return resp;
    }
    ...
    public BaseWebResponse queryProductList(QueryProductListRequest req) {
        log.info("P2PProductBizImpl.queryProductList.req:" + JSON.toJSONString(req));
        BaseWebResponse resp = null;
        try {
            // 调用产品列表查询http服务接口
        ...
        log.info("P2PProductBizImpl.queryProductList.resp:" + JSON.toJSONString(resp));
        return resp;
    ...
    public BaseWebResponse queryProductDetail(String productCode) {
        log.info("P2PProductBizImpl.queryProductDetail.req:" + JSON.toJSONString(productCode));
        BaseWebResponse resp = null;
        try {
        ...
        log.info("P2PProductBizImpl.queryProductDetail.resp:" + JSON.toJSONString(resp));
        return resp;
    ...
    public BaseWebResponse putProductOnLine(UpdateProductSaleStatusRequest req) {
        log.info("P2PProductBizImpl.putProductOnLine.req:" + JSON.toJSONString(req));
        BaseWebResponse resp = null;
        try {
            BaseResponse baseResponse = putProductOnLineUseHttp(req);
        ...
        log.info("P2PProductBizImpl.putProductOnLine.resp:" + JSON.toJSONString(resp));
        return resp;
    }
    ...
    public BaseWebResponse putProductOffLine(UpdateProductSaleStatusRequest req) {
        log.info("P2PProductBizImpl.putProductOffLine.req:" + JSON.toJSONString(req));
        BaseWebResponse resp = null;
        try {
            // 调用产品下线http服务接口
        ...
        log.info("P2PProductBizImpl.putProductOffLine.resp:" + JSON.toJSONString(resp));
        return resp;
    }
    ...
    public BaseWebResponse approveProduct(ApproveProductRequest req) {
        log.info("P2PProductBizImpl.approveProduct.req:" + JSON.toJSONString(req));
        BaseWebResponse resp = null;
        try {
            req.setSign(sign); // 授权级别
            //BaseResponse baseResponse = productServiceFacade.approveProduct(req);
            // 调用产品审核http服务接口
            BaseResponse baseResponse = productApprovalUseHttp(req);
            if (ResultCode.SUCCESS.code().equals(baseResponse.getRespCode())) {
                resp = new BaseWebResponse(RespCode.SUCCESS.code(), ResultCode.SUCCESS.code(), ResultCode.SUCCESS.desc());
        ...
        log.info("P2PProductBizImpl.approveProduct.resp:" + JSON.toJSONString(resp));
        return resp;
    }
    ...
    public BaseWebResponse countUpProductStatus() {
        log.info("P2PProductBizImpl.countUpProductStatus.req:");
...
//            }
        ...
        log.info("P2PProductBizImpl.countUpProductStatus.resp:" + JSON.toJSONString(resp));
        return resp;
    }
    ...
    public BaseWebResponse queryProductApprovalList(QueryProductApprovalListRequest req, String createBy) {
        log.info("P2PProductBizImpl.queryProductApprovalList.req:" + JSON.toJSONString(req));
        BaseWebResponse resp = null;
        try {
        ...
        log.info("P2PProductBizImpl.queryProductApprovalList.resp:" + JSON.toJSONString(resp));
        return resp;
    }
    ...
    private void setQueryProductModelList(List<QueryProductModel> queryProductModelList, List<ProductModel> productModelList) {
        for (ProductModel productModel : productModelList) {
            ...
            model.setLoanOrderNoSet(productModel.getLoanOrderNoSet());
            model.setCollectMode(productModel.getCollectMode());
            String saleStatus = "";
            ...
            model.setProductPeriodModel(productModel.getProductPeriodModel());
            model.setProductProfitModel(productModel.getProductProfitModel());
            model.setProductStockModel(productModel.getProductStockModel());
    ...
    private void setQueryProductDetailModel(QueryProductDetailModel model, QueryProductInfoResponse resp) {
        ...
        model.setOpenType(productModel.getOpenType());
        model.getRegisterType(productModel.getRegisterType());
        model.setPayChannel(productModel.getPayChannel());
        model.setBuyWays(productModel.getBuyWays());
        model.setNumberPeriod(productModel.getNumberPeriod());
        ...
        if (productModel.getProductPeriodModel() != null
            ...
            saleStartTime = ft.format(productModel.getProductPeriodModel().getSaleStartTime());
        }
        ...
        if (productModel.getProductPeriodModel() != null
            ...
            saleEndTime = ft.format(productModel.getProductPeriodModel().getSaleEndTime());
        }
        ...
        String expectEstablishTime = "";
        if (productModel.getProductPeriodModel() != null
                && productModel.getProductPeriodModel().getExpectEstablishTime() != null) {
        	expectEstablishTime = formatter.format(productModel.getProductPeriodModel().getExpectEstablishTime());
        }
        model.setExpectEstablishTime(expectEstablishTime); // 到期回款日(预期结清日)
    ...
    public RegisterProductResponse productRegisterUseHttp(RegisterProductRequest req) throws Exception {
        ...
        // 调用远程服务
        log.info("产品注册 调用pms请求地址"+productRegisterUrl+" 请求参数：" + JSONObject.toJSONString(req));
    ...
    public PageQueryResponse<ProductModel> productListQueryUseHttp(QueryProductListRequest req) throws Exception {
        ...
        String respContent = null;
        // 调用远程服务
        log.info("产品列表查询 调用pms请求地址"+productListQueryUrl+" 请求参数：" + JSONObject.toJSONString(req));
    ...
    public QueryProductInfoResponse productInfoQueryUseHttp(QueryProductInfoRequest req) throws Exception {
        ...
        String respContent = null;
        // 调用远程服务
        log.info("产品详情查询 调用pms请求地址"+productInfoQueryUrl+" 请求参数：" + JSONObject.toJSONString(req));
     ...
     * @throws Exception
     */
    public BaseResponse putProductOnLineUseHttp(UpdateProductSaleStatusRequest req) throws Exception {
        BaseResponse baseResponse = null;
        String reqeustUrl=productOnLineUrl;
        String respContent = null;
        
        // 调用远程服务
        log.info("产品上线 调用pms请求地址"+productOnLineUrl+" 请求参数：" + JSONObject.toJSONString(req));
    ...
    public BaseResponse putProductOffLineUseHttp(UpdateProductSaleStatusRequest req) throws Exception {
        ...
        String respContent = null;
        // 调用远程服务
        log.info("产品下线 调用pms请求地址"+productOffLineUrl+" 请求参数：" + JSONObject.toJSONString(req));
     ...
     * @throws Exception
     */
    public BaseResponse productApprovalUseHttp(ApproveProductRequest req) throws Exception {
        BaseResponse baseResponse = null;
        String respContent = null;
        // 调用远程服务
        log.info("产品审核 调用pms请求地址"+productApprovalUrl+" 请求参数：" + JSONObject.toJSONString(req));
    ...
    public QueryProductApprovalInfoResponse queryProductApprovalListUseHttp(QueryProductApprovalListRequest req) throws Exception {
        ...
        String respContent = null;
        // 调用远程服务
        log.info("产品审核信息列表查询 调用pms请求地址"+productApprovalInfoListUrl+" 请求参数：" + JSONObject.toJSONString(req));
    ...
    public ProductStatisticsResponse productStatistics(QueryProductListRequest req) throws Exception {
        ...
        String respContent = null;
        // 调用远程服务
        log.info("产品统计查询 调用pms请求地址"+productStatisticsUrl+" 请求参数：" + JSONObject.toJSONString(req));
